# CS310 Project - BeConSUlt

## Description
BeConSUlt is a mobile application designed to help Sabancı University students make smarter and more informed course selections. It offers a centralized, anonymous platform where students can share and find honest comments regarding lectures and instructors.
...
|------|------|------------------|
| Erenalp Küçükodacı |31913| Project Coordinator |
