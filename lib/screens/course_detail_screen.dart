          ...
          children: [
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                label: const Text("View All Student Comments", style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold)),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            Text(data.name, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500, fontFamily: AppTextStyles.fontFamily)),
              ...
              child: Row(
                children: [
                  ...
                  Text("${data.commentCount} comments",
                      style: const TextStyle(color: Colors.grey, decoration: TextDecoration.underline, fontFamily: AppTextStyles.fontFamily)),
                ],
              ),
            ),
          ],
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text("Course Description", style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold, fontSize: 16, fontFamily: AppTextStyles.fontFamily)),
  ...
  Widget _detailItem(String label, String value) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 4),
        Text(value, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14, fontFamily: AppTextStyles.fontFamily)),
      ],
    );
  }
}